package dmdd.dmddas.dataaccess.bizobject
{
	...
	[Bindable]
	[RemoteClass(alias="dmdd.dmddjava.dataaccess.bizobject.BForecastModelMSTEsa")]	
	public class BForecastModelMSTEsa extends BForecastModelM
	{
		public function BForecastModelMSTEsa()
		{
			//TODO: implement function
			super();
			super.indicator = BizConst.FORECASTMODELM_INDICATOR_STESA;
		}
		...
		{
			var sourceObj:BForecastModelMSTEsa = BForecastModelMSTEsa(_obj);
