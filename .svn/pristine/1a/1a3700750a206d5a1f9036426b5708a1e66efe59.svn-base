package dmdd.dmddas.dataaccess.aidobject
{
	...
	[Bindable]
	[RemoteClass(alias="dmdd.dmddjava.dataaccess.aidobject.ABImHistoryData")]	
	public class ABImHistoryData
	{
		public function ABImHistoryData()
		{
		...
		public function copyDeep( _sourceObj:ABImHistoryData ):void
		{
			if( _sourceObj == null )
			{
				return;
