package dmdd.dmddas.common.constant
{
	...
	{		
		...
		public static var SYSPARAM_CODE_ISSUPPORT_SUIT:String = "SYSPARAM_CODE_ISSUPPORT_SUIT"; //是否支持套装折合
		//	系统参数		end
		...
		public static var AMOUNT_BIZ_DATA_SUFFIX:String = "_SYS_AMOUNT";
		
		public static var SUIT_SUPPORT:String = "true";
		/**支持*/
		public static var SUIT_SUPPORT_TWO:int = 2;
		/**不支持*/
		public static var SUIT_SUPPORT_ONE:int = 1;
	}
}