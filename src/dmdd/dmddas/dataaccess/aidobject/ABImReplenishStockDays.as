package dmdd.dmddas.dataaccess.aidobject
{
	...
	[Bindable]
	[RemoteClass(alias="dmdd.dmddjava.dataaccess.aidobject.ABImReplenishStockDays")]	
	public class ABImReplenishStockDays
	{
		public function ABImReplenishStockDays()
		{
		}
		public var productCode:String = null;
		public var dcCode:String = null;
		public var termEndCode:String = null;
		public var periodBegin:int;
		...
		public function copyDeep( _sourceObj:ABImReplenishStockDays ):void
		{
			if( _sourceObj == null )
			{
				return;
			...
			this.dcCode = _sourceObj.dcCode;
			this.termEndCode = _sourceObj.termEndCode;
