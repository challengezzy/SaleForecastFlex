package dmdd.dmddas.dataaccess.aidobject
{
	...
	[Bindable]
	[RemoteClass(alias="dmdd.dmddjava.dataaccess.aidobject.ABImForecastData")]	
	public class ABImForecastData
	{
		public function ABImForecastData()
		{
		...
		public function copyDeep( _sourceObj:ABImForecastData ):void
		{
			if( _sourceObj == null )
			{
				return;
			...
			this.warnInfo = _sourceObj.warnInfo;
